...
export const CHANGELOG_DATA: VersionEntry[] = [
    {
        version: 'v3.1.0',
        date: '15 Jan 2026',
        titleSv: 'Next.js Migration & Prestanda',
        titleAr: 'الانتقال إلى Next.js وتحسين الأداء',
        changes: [
            { type: 'feature', sv: 'Next.js App Router:', ar: 'بنية Next.js:', detailSv: 'Fullständig migrering till modern Next.js arkitektur', detailAr: 'نقل كامل لبنية التطبيق إلى Next.js الحديثة' },
            { type: 'performance', sv: 'iOS Scroll:', ar: 'تمرير iOS:', detailSv: 'Löst scroll-problem och förbättrat flyt på iPhone', detailAr: 'حل مشاكل التمرير وتحسين السلاسة على الآيفون' },
            { type: 'feature', sv: 'Färgtema:', ar: 'سمة الألوان:', detailSv: 'Omedelbar synkronisering av accentfärg utan omladdning', detailAr: 'تزامن فوري للون التمييز دون الحاجة لإعادة التحميل' },
            { type: 'improvement', sv: 'Navigation:', ar: 'التنقل:', detailSv: 'Persistent menyrad som stannar kvar vid sidbyten', detailAr: 'شريط تنقل ثابت يبقى ظاهراً عند تغيير الصفحات' }
        ]
    },
    {
        version: 'v3.0.2',
