import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              *//* empty css                            *//* empty css                       */import{showToast as F}from"./utils-DkwAXeNx.js";import{s as j}from"./tts-BuOrQ7kI.js";import{A as p}from"./config-CfHoVMbv.js";import{L as U}from"./i18n-1qhfGv7S.js";import"./ui-enhancements-sg46XY7N.js";import{T as X}from"./toast-manager-CZ3snF2j.js";import"./pwa-Bxh5GLjF.js";function H(){console.log("[GamesUI] Initializing..."),b(),w(),k(),S(),V(),W(),requestAnimationFrame(()=>{te()}),window.dictionaryData?y():window.addEventListener("dictionaryLoaded",()=>y(),{once:!0}),window.filterGames=Q,window.openDailyChallenge=Z,window.updateGameScore=K,window.updateGamesStats=J,window.trackGamePlayed=ee}function V(){const e=document.getElementById("mobileToggle");e&&e.addEventListener("click",()=>{var t;(t=window.MobileViewManager)==null||t.toggle()})}function W(){"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("../sw.js").then(e=>{console.log("SW registered: ",e),e.update()}).catch(e=>{console.error("SW registration failed: ",e)})})}function b(){const e=JSON.parse(localStorage.getItem("gamesStats")||'{"gamesPlayed": 0, "winStreak": 0, "totalScore": 0}'),t=document.getElementById("gamesPlayedStat"),a=document.getElementById("winStreakStat"),s=document.getElementById("totalScoreStat");t&&(t.textContent=e.gamesPlayed||0),a&&(a.textContent=e.winStreak||0),s&&(s.textContent=e.totalScore||0)}function J(e,t=0){const a=JSON.parse(localStorage.getItem("gamesStats")||'{"gamesPlayed": 0, "winStreak": 0, "totalScore": 0}');a.gamesPlayed++,a.totalScore+=t,e?a.winStreak++:a.winStreak=0,localStorage.setItem("gamesStats",JSON.stringify(a)),b(),z()}function w(){var s;const e=new Date().toISOString().split("T")[0];let t=JSON.parse(localStorage.getItem("dailyGameChallenge")||"{}");t.date!==e&&(t={date:e,gamesPlayed:0,completed:!1},localStorage.setItem("dailyGameChallenge",JSON.stringify(t)));const a=document.getElementById("dailyProgress");a&&(a.textContent=`${t.gamesPlayed}/3`),t.completed&&((s=document.getElementById("dailyChallengeBanner"))==null||s.classList.add("completed"))}function z(){const e=new Date().toISOString().split("T")[0];let t=JSON.parse(localStorage.getItem("dailyGameChallenge")||"{}");if(t.date!==e&&(t={date:e,gamesPlayed:0,completed:!1}),!t.completed){if(t.gamesPlayed++,t.gamesPlayed>=3){t.completed=!0;const a=JSON.parse(localStorage.getItem("gamesStats")||"{}");a.totalScore=(a.totalScore||0)+100,localStorage.setItem("gamesStats",JSON.stringify(a)),F('<span class="sv-text">🎉 Daglig utmaning klar! +100 poäng</span><span class="ar-text">🎉 تحدي اليوم مكتمل! +100 نقطة</span>')}localStorage.setItem("dailyGameChallenge",JSON.stringify(t))}w()}function Z(){const e=document.querySelector(".game-cards-grid");e&&e.scrollIntoView({behavior:"smooth"})}const Y={vocab:["Vokaler","Neon Search","Hangman","Memory","Minneskor","Bokstav Länk","Ord Hjulet","Svenska Wordle","Gissa Ordet"],grammar:["Grammatik","Bygg Meningen","Fyll i"],listening:["Lyssna","Uttalscoach"],puzzle:["Lås Upp","Neon Blocks","Ord-Regn"]};function Q(e){var a;document.querySelectorAll(".category-chip").forEach(s=>s.classList.remove("active")),(a=document.querySelector(`[data-cat="${e}"]`))==null||a.classList.add("active"),document.querySelectorAll(".game-card-item").forEach(s=>{var n;const o=((n=s.querySelector("h3"))==null?void 0:n.textContent)||"";if(e==="all")s.style.display="";else{const r=(Y[e]||[]).some(l=>o.includes(l));s.style.display=r?"":"none"}})}function k(){const e=JSON.parse(localStorage.getItem("gameScores")||"{}");document.querySelectorAll(".game-stars").forEach(t=>{const a=t.dataset.game;if(!a)return;const s=e[a]||0;let o=0;s>=100?o=3:s>=50?o=2:s>=10&&(o=1),o>0&&t.setAttribute("data-stars",o.toString())})}function K(e,t){const a=JSON.parse(localStorage.getItem("gameScores")||"{}"),s=a[e]||0;t>s&&(a[e]=t,localStorage.setItem("gameScores",JSON.stringify(a))),k()}function S(){const e=JSON.parse(localStorage.getItem("gamesStats")||"{}"),t=new Date().toISOString().split("T")[0],a=_(),s=e.bestStreak||e.winStreak||0,o=document.getElementById("bestStreak");o&&(o.textContent=s);const n=JSON.parse(localStorage.getItem("dailyGamesLog")||"{}"),i=n[t]||0,r=document.getElementById("todayGames");r&&(r.textContent=i);let l=0;Object.keys(n).forEach(c=>{c>=a&&(l+=n[c])});const d=document.getElementById("weeklyGames");d&&(d.textContent=l.toString())}function _(){const e=new Date,t=e.getDay(),a=e.getDate()-t+(t===0?-6:1);return new Date(e.setDate(a)).toISOString().split("T")[0]}function ee(){const e=new Date().toISOString().split("T")[0],t=JSON.parse(localStorage.getItem("dailyGamesLog")||"{}");t[e]=(t[e]||0)+1,localStorage.setItem("dailyGamesLog",JSON.stringify(t));const a=JSON.parse(localStorage.getItem("gamesStats")||"{}");(!a.bestStreak||a.winStreak>a.bestStreak)&&(a.bestStreak=a.winStreak,localStorage.setItem("gamesStats",JSON.stringify(a))),S()}function y(){const e=window.dictionaryData;if(!e||!e.length)return;const t=new Date().toISOString().split("T")[0];let a=JSON.parse(localStorage.getItem("wotd_cache")||"{}");if(a.date!==t){const d=Math.floor(Math.random()*e.length);let c=e[d];for(let v=0;v<10&&!c[p.COLUMNS.EXAMPLE_SWE];v++)c=e[Math.floor(Math.random()*e.length)];a={date:t,word:c},localStorage.setItem("wotd_cache",JSON.stringify(a))}const s=a.word;if(!s)return;const o=document.getElementById("wordOfTheDay");o&&(o.style.display="block");const n=document.getElementById("wotd-swedish"),i=document.getElementById("wotd-arabic"),r=document.getElementById("wotd-example");n&&(n.textContent=s[p.COLUMNS.SWEDISH]),i&&(i.textContent=s[p.COLUMNS.ARABIC]),r&&(r.innerHTML=s[p.COLUMNS.EXAMPLE_SWE]||'<span class="sv-text">Ingen exempelmening</span><span class="ar-text">لا يوجد مثال</span>');const l=document.getElementById("wotd-speak-btn");l&&(l.onclick=d=>{d.stopPropagation(),j(s[p.COLUMNS.SWEDISH]);const c=l.querySelector("svg");c&&(c.style.fill="#fff"),setTimeout(()=>{c&&(c.style.fill="none")},1e3)})}function te(){const e=document.querySelectorAll(".game-card-item");e.length&&e.forEach(t=>{const a=t;a.addEventListener("mousemove",s=>{const o=a.getBoundingClientRect(),n=s.clientX-o.left,i=s.clientY-o.top,r=o.width/2,l=o.height/2,d=(i-l)/l*-8,c=(n-r)/r*8;a.style.transform=`perspective(1000px) rotateX(${d}deg) rotateY(${c}deg) scale(1.02)`}),a.addEventListener("mouseleave",()=>{a.style.transform="perspective(1000px) rotateX(0) rotateY(0) scale(1)"})})}typeof window<"u"&&document.addEventListener("DOMContentLoaded",()=>{U.init(),H()});const x={isActive:!1,init(){this.isActive=localStorage.getItem("focusMode")==="true",this.isActive&&document.body.classList.add("focus-mode")},createToggleButton(){if(document.querySelector(".focus-mode-toggle"))return;const t=document.createElement("button");t.className="focus-mode-toggle",t.setAttribute("aria-label","Toggle Focus Mode"),t.innerHTML=`
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" 
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
            </svg>
        `,t.addEventListener("click",()=>this.toggle()),document.body.appendChild(t)},toggle(){this.isActive=!this.isActive,document.body.classList.toggle("focus-mode",this.isActive),localStorage.setItem("focusMode",String(this.isActive)),"vibrate"in navigator&&navigator.vibrate(this.isActive?[20,50,20]:10),g(this.isActive?"Fokusläge aktiverat ✨":"Fokusläge avaktiverat",this.isActive?"success":"info")}},m={xpPerLevel:100,levelMultiplier:1.5,getProgress(){const e=localStorage.getItem("userProgress");return e?JSON.parse(e):{xp:0,level:1,streak:0,gamesPlayed:0,totalScore:0,wordsLearned:0,timeSpent:0,achievements:[],lastPlayDate:"",dailyGoalsCompleted:0}},saveProgress(e){localStorage.setItem("userProgress",JSON.stringify(e))},getXPForLevel(e){return Math.floor(this.xpPerLevel*Math.pow(this.levelMultiplier,e-1))},addXP(e){const t=this.getProgress();t.xp+=e;const a=this.getXPForLevel(t.level);let s=!1;for(;t.xp>=a;)t.xp-=a,t.level++,s=!0;return this.saveProgress(t),s&&this.showLevelUp(t.level),{newLevel:s,level:t.level,totalXP:t.xp}},showLevelUp(e){const t=document.createElement("div");t.className="level-up-overlay",t.innerHTML=`
        ...
        `,document.body.appendChild(t),u.play("achievement"),h.confetti({particleCount:80,spread:60}),"vibrate"in navigator&&navigator.vibrate([30,50,30,50,30]),setTimeout(()=>{t.style.animation="fadeOut 0.5s ease forwards",setTimeout(()=>t.remove(),500)},3500)},showBadges(e){this.loadUnlocked();const t=document.createElement("div");t.className="achievements-grid",t.style.cssText="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; padding: 16px;",this.list.forEach(a=>{const s=document.createElement("div");s.className=`achievement-badge ${a.unlocked?"unlocked":"locked"}`,s.innerHTML=`
            ...
            `).join("")}
        `,e.appendChild(t)}},ae={rewards:[{type:"xp",value:10,icon:"✨",name:"10 XP"},{type:"xp",value:25,icon:"⭐",name:"25 XP"},{type:"xp",value:50,icon:"💫",name:"50 XP"},{type:"xp",value:100,icon:"🌟",name:"100 XP"},{type:"streak-freeze",value:1,icon:"❄️",name:"Streak Freeze"},{type:"double-xp",value:1,icon:"🔥",name:"Dubbel XP (1 spel)"}],canOpen(){const e=m.getProgress();if(!e.mysteryBoxLastOpened)return!0;const t=new Date(e.mysteryBoxLastOpened);return(new Date().getTime()-t.getTime())/(1e3*60*60)>=24},open(){if(!this.canOpen())return g("Vänta till imorgon för nästa låda! 📦","info"),null;const e=this.rewards[Math.floor(Math.random()*this.rewards.length)],t=m.getProgress();return t.mysteryBoxLastOpened=new Date().toISOString(),m.saveProgress(t),e.type==="xp"&&m.addXP(e.value),this.showReward(e),e},showReward(e){const t=document.createElement("div");t.className="level-up-overlay",t.innerHTML=`
            <div class="level-up-content">
                <div class="mystery-box opening">
                    <span class="mystery-box-icon">🎁</span>
                </div>
            </div>
        `,document.body.appendChild(t),u.play("mysteryBox"),setTimeout(()=>{t.innerHTML=`
                <div class="level-up-content">
                    <div class="level-up-icon">${e.icon}</div>
                    <h2 class="level-up-title">${e.name}!</h2>
                    <p class="level-up-subtitle">Du fick en belöning!</p>
                </div>
            `,h.confetti({particleCount:100,spread:80}),"vibrate"in navigator&&navigator.vibrate([50,100,50])},1e3),setTimeout(()=>{t.classList.add("fade-out"),setTimeout(()=>t.remove(),500)},4e3)},render(e){const t=this.canOpen(),a=document.createElement("div");a.style.cssText="display: flex; flex-direction: column; align-items: center; gap: 12px; padding: 20px;",a.innerHTML=`
        ...
        `,t.addEventListener("click",()=>this.toggle()),document.body.appendChild(t)},toggle(){this.enabled=!this.enabled,localStorage.setItem("soundEnabled",String(this.enabled));const e=document.querySelector(".sound-toggle");e&&e.classList.toggle("muted",!this.enabled),this.enabled&&this.play("click"),g(this.enabled?"🔊 Ljud på":"🔇 Ljud av","info")},play(e){if(this.enabled)try{const t=new(window.AudioContext||window.webkitAudioContext),a=t.createOscillator(),s=t.createGain();switch(a.connect(s),s.connect(t.destination),s.gain.value=this.volume*.1,e){case"success":a.frequency.setValueAtTime(523.25,t.currentTime),a.frequency.setValueAtTime(659.25,t.currentTime+.1),a.frequency.setValueAtTime(783.99,t.currentTime+.2);break;case"error":a.frequency.setValueAtTime(200,t.currentTime);break;case"click":a.frequency.setValueAtTime(800,t.currentTime),s.gain.exponentialRampToValueAtTime(.01,t.currentTime+.05);break;case"achievement":case"levelUp":a.frequency.setValueAtTime(392,t.currentTime),a.frequency.setValueAtTime(523.25,t.currentTime+.1),a.frequency.setValueAtTime(659.25,t.currentTime+.2),a.frequency.setValueAtTime(783.99,t.currentTime+.3);break;case"notification":a.frequency.setValueAtTime(440,t.currentTime),a.frequency.setValueAtTime(660,t.currentTime+.1);break;default:a.frequency.setValueAtTime(440,t.currentTime)}a.type="sine",a.start(t.currentTime),a.stop(t.currentTime+.3)}catch{console.log("Audio not supported")}}},h={confetti(e={}){const t={particleCount:e.particleCount||100,spread:e.spread||70,origin:e.origin||{x:.5,y:.6}};if(typeof window.confetti=="function"){window.confetti(t);return}this.cssConfetti(t.particleCount)},cssConfetti(e=50){const t=document.createElement("div");t.className="confetti-container";const a=["#ff6b6b","#4ecdc4","#45b7d1","#96ceb4","#ffeaa7","#fd79a8","#a29bfe","#6c5ce7"];for(let s=0;s<e;s++){const o=document.createElement("div");o.className="confetti-piece",o.style.left=`${Math.random()*100}%`,o.style.background=a[Math.floor(Math.random()*a.length)],o.style.animationDelay=`${Math.random()*.5}s`,o.style.animationDuration=`${2+Math.random()}s`,t.appendChild(o)}document.body.appendChild(t),setTimeout(()=>t.remove(),3e3)}};function g(e,t="info"){X.show(e,{type:t})}function se(e,t,a=100,s=8){const o=(a-s)/2,n=o*2*Math.PI,i=n-t/100*n;e.innerHTML=`
    ...
    `,e.className="progress-ring-container"}document.addEventListener("DOMContentLoaded",()=>{setTimeout(()=>{x.init(),u.init(),E.init(),A.loadUnlocked(),f.load(),f.updateProgress("streak",1)},500)});typeof window<"u"&&(window.FocusMode=x,window.XPSystem=m,window.Achievements=A,window.DailyGoals=f,window.MysteryBox=ae,window.PomodoroTimer=E,window.SoundEffects=u,window.Celebrations=h,window.createProgressRing=se,window.showToast=g);const M={init(){document.querySelectorAll(".game-card-item").forEach(e=>{this.addTiltEffect(e)})},addTiltEffect(e){e.classList.add("tilt-card");const t=document.createElement("div");t.className="tilt-shine",e.appendChild(t),e.addEventListener("mousemove",a=>{const s=e.getBoundingClientRect(),o=a.clientX-s.left,n=a.clientY-s.top,i=s.width/2,r=s.height/2,l=(n-r)/10,d=(i-o)/10;e.style.setProperty("--tilt-x",`${l}deg`),e.style.setProperty("--tilt-y",`${d}deg`),t.style.background=`radial-gradient(circle at ${o}px ${n}px, rgba(255,255,255,0.2) 0%, transparent 50%)`}),e.addEventListener("mouseleave",()=>{e.style.setProperty("--tilt-x","0deg"),e.style.setProperty("--tilt-y","0deg")})}},L={difficulties:{flashcards:"easy",vokaler:"medium","unblock-me":"hard","block-puzzle":"medium","word-search":"easy",hangman:"medium",memory:"easy","word-wheel":"medium","word-connect":"hard","fill-blank":"medium",listening:"medium",grammar:"hard","missing-word":"medium",spelling:"hard","sentence-builder":"hard","word-rain":"medium",wordle:"hard",pronunciation:"hard"},labels:{easy:{sv:"Lätt",ar:"سهل"},medium:{sv:"Medel",ar:"متوسط"},hard:{sv:"Svårt",ar:"صعب"}},init(){document.querySelectorAll(".game-card-item").forEach(e=>{const t=e.getAttribute("data-game-id");t&&this.difficulties[t]&&this.addBadge(e,this.difficulties[t])})},addBadge(e,t){var o;if(e.querySelector(".difficulty-badge"))return;const s=document.createElement("span");s.className=`difficulty-badge difficulty-${t}`,s.textContent=((o=this.labels[t])==null?void 0:o.sv)||t,e.appendChild(s)}},T={init(){const e=localStorage.getItem("lastPlayedGame");if(!e)return;const t=JSON.parse(e),a=document.querySelector(`[data-game-id="${t.gameId}"]`);a&&this.addBadge(a)},addBadge(e){if(e.querySelector(".last-played-badge"))return;const a=document.createElement("div");a.className="last-played-badge",a.innerHTML=`
            <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z"/>
            </svg>
            Senast
        `,e.appendChild(a)},recordPlay(e){localStorage.setItem("lastPlayedGame",JSON.stringify({gameId:e,timestamp:Date.now()}))}},B={recommendations:{memory:5,flashcards:5,grammar:4,vokaler:5,"word-connect":4,hangman:4,"fill-blank":3,listening:4,"word-wheel":3,wordle:3,pronunciation:4,spelling:3,"sentence-builder":3,"word-rain":4,"missing-word":3,"unblock-me":2,"block-puzzle":2,"word-search":3},init(){document.querySelectorAll(".game-card-item").forEach(e=>{const t=e.getAttribute("data-game-id");t&&this.recommendations[t]&&this.addStars(e,this.recommendations[t])})},addStars(e,t){var n;if(e.querySelector(".recommendation-stars"))return;const s=document.createElement("div");s.className="recommendation-stars";for(let i=1;i<=5;i++){const r=document.createElement("svg");r.className=`recommendation-star ${i>t?"empty":""}`,r.setAttribute("viewBox","0 0 24 24"),r.innerHTML='<path fill="currentColor" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>',s.appendChild(r)}const o=e.querySelector(".high-score, .game-stars");o?(n=o.parentNode)==null||n.insertBefore(s,o.nextSibling):e.appendChild(s)}},C={init(){if(document.querySelector(".particles-container"))return;const t=document.createElement("div");t.className="particles-container";for(let a=0;a<15;a++){const s=document.createElement("div");s.className="particle",s.style.animationDelay=`${Math.random()*10}s`,s.style.left=`${Math.random()*100}%`,t.appendChild(s)}document.body.insertBefore(t,document.body.firstChild)}},I={baseCount:12,init(){const e=document.querySelector(".games-container");if(!e||document.querySelector(".live-players-widget"))return;const a=this.createWidget(),s=document.getElementById("xpWidget");if(s&&s.nextSibling)e.insertBefore(a,s.nextSibling);else{const o=document.querySelector(".games-header");o&&o.nextSibling&&e.insertBefore(a,o.nextSibling)}this.startUpdating()},createWidget(){const e=this.getRandomCount(),t=document.createElement("div");return t.className="live-players-widget",t.innerHTML=`
        ...
        `,t},createAvatars(e){const t=["👤","🧑","👩","🧑‍🦱","👨","👧","🧒"];let a="";for(let s=0;s<e;s++)a+=`<div class="live-avatar">${t[s%t.length]}</div>`;return a},getRandomCount(){return this.baseCount+Math.floor(Math.random()*20)},startUpdating(){setInterval(()=>{const e=document.getElementById("livePlayerCount");if(e){const t=this.getRandomCount();e.textContent=String(t)}},15e3)}},P={quotes:[{text:"Varje ord du lär dig är ett steg närmare fluency.",author:"SnabbaLexin",textAr:"كل كلمة تتعلمها هي خطوة نحو الطلاقة."},{text:"Övning ger färdighet. Fortsätt träna!",author:"Svenskt ordspråk",textAr:"الممارسة تصنع الكمال. استمر في التدريب!"},{text:"Att lära sig ett nytt språk är att öppna en ny dörr.",author:"Frank Smith",textAr:"تعلم لغة جديدة هو فتح باب جديد."},{text:"Din streak visar ditt engagemang. Imponerande!",author:"SnabbaLexin",textAr:"سلسلتك تظهر التزامك. مثير للإعجاب!"},{text:"Små framsteg varje dag leder till stora resultat.",author:"Kinesiskt ordspråk",textAr:"التقدم الصغير كل يوم يؤدي إلى نتائج كبيرة."},{text:"Du är en stjärna! Fortsätt lysa.",author:"SnabbaLexin",textAr:"أنت نجم! استمر في التألق."},{text:"Misstag är bevis på att du försöker.",author:"Okänd",textAr:"الأخطاء دليل على أنك تحاول."},{text:"Språket är nyckeln till en annan kultur.",author:"Rita Mae Brown",textAr:"اللغة هي مفتاح ثقافة أخرى."}],currentIndex:0,init(){const e=document.querySelector(".games-container");if(!e||document.querySelector(".quote-widget"))return;this.currentIndex=Math.floor(Math.random()*this.quotes.length);const a=this.createWidget(),s=document.querySelector(".live-players-widget");if(s&&s.nextSibling)e.insertBefore(a,s.nextSibling);else{const o=document.querySelector(".stats-hero");o&&e.insertBefore(a,o)}},createWidget(){var a;const e=this.quotes[this.currentIndex],t=document.createElement("div");return t.className="quote-widget",t.innerHTML=`
        ...
        `}).join("")}},q={intervalMinutes:30,timer:null,startTime:0,init(){this.startTime=Date.now(),this.scheduleReminder()},scheduleReminder(){this.timer&&clearTimeout(this.timer),this.timer=setTimeout(()=>{this.showReminder()},this.intervalMinutes*60*1e3)},showReminder(){var t,a;const e=document.createElement("div");e.className="break-reminder-overlay",e.id="breakReminder",e.innerHTML=`
        ...
        `,t.addEventListener("click",()=>this.toggle()),document.body.appendChild(t)},toggle(){this.isActive=!this.isActive,document.body.classList.toggle("eye-care-mode",this.isActive),localStorage.setItem("eyeCareMode",String(this.isActive)),typeof window.showToast=="function"&&window.showToast(this.isActive?"👁️ Eye Care aktiverat":"👁️ Eye Care avaktiverat","info")}},N={messages:["Lycka till! 🍀","Du klarar det! 💪","Fortsätt så! 🌟","Imponerande! 👏","Bra jobbat! 🎉","Du är grym! 🔥"],init(){},getRandomMessage(){return this.messages[Math.floor(Math.random()*this.messages.length)]},speak(){const e=document.getElementById("mascotSpeech");e&&(e.textContent=this.getRandomMessage(),e.style.opacity="1",setTimeout(()=>{e.style.opacity="0"},2e3)),"vibrate"in navigator&&navigator.vibrate(10)}},D={players:[{name:"Erik S.",score:2450,emoji:"🧑"},{name:"Sara A.",score:2180,emoji:"👩"},{name:"Mohammed K.",score:1950,emoji:"🧔"},{name:"Lisa N.",score:1820,emoji:"👧"},{name:"Du",score:0,emoji:"⭐",isCurrentUser:!0}],init(){const e=document.querySelector(".leaderboard-section");if(!e||document.querySelector(".leaderboard-widget"))return;const a=this.getUserScore();this.players[4].score=a,this.players.sort((o,n)=>n.score-o.score);const s=this.createWidget();e.appendChild(s)},getUserScore(){const e=localStorage.getItem("userProgress");return e&&JSON.parse(e).totalScore||0},createWidget(){const e=document.createElement("div");return e.className="leaderboard-widget",e.innerHTML=`
            ...
            `).join("")}
        `,e}},G={recommendations:[{game:"memory",reason:"Bra för att träna minnet",reasonAr:"جيد لتدريب الذاكرة"},{game:"grammar",reason:"Förbättra din grammatik",reasonAr:"حسّن قواعدك"},{game:"listening",reason:"Träna hörförståelse",reasonAr:"درب مهارة الاستماع"},{game:"vokaler",reason:"Lär dig svenska ljud",reasonAr:"تعلم الأصوات السويدية"}],init(){const e=document.querySelector(".games-container");if(!e||document.querySelector(".ai-recommendation"))return;const a=this.getRecommendation(),s=this.createWidget(a),o=document.querySelector(".category-filter-container");o&&e.insertBefore(s,o.nextSibling)},getRecommendation(){return this.recommendations[Math.floor(Math.random()*this.recommendations.length)]},createWidget(e){const t=document.createElement("div");return t.className="ai-recommendation",t.innerHTML=`
        ...
        `,t.addEventListener("click",()=>{const a=document.querySelector(`[data-game-id="${e.game}"]`);a&&(a.scrollIntoView({behavior:"smooth",block:"center"}),a.style.animation="pulse 0.5s ease")}),t}},oe={init(){const e=new IntersectionObserver(t=>{t.forEach(a=>{a.isIntersecting&&(a.target.classList.add("bounce-scroll"),e.unobserve(a.target))})},{threshold:.1});document.querySelectorAll(".game-card-item").forEach(t=>{e.observe(t)})}};document.addEventListener("DOMContentLoaded",()=>{setTimeout(()=>{M.init(),L.init(),T.init(),B.init(),C.init(),N.init(),I.init(),P.init(),D.init(),G.init(),q.init(),O.init(),$.init(),oe.init()},800)});typeof window<"u"&&(window.TiltEffect=M,window.DifficultyIndicator=L,window.LastPlayedBadge=T,window.RecommendationStars=B,window.ParticleBackground=C,window.LivePlayersCounter=I,window.MotivationalQuotes=P,window.ProgressDashboard=$,window.BreakReminder=q,window.EyeCareMode=O,window.GameMascot=N,window.WeeklyLeaderboard=D,window.AIRecommendations=G);const R={isOpen:!1,menuElement:null,menuItems:[{id:"focus-mode",icon:`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
...
`;function ie(){const e="fab-menu-styles";if(document.getElementById(e))return;const t=document.createElement("style");t.id=e,t.textContent=ne,document.head.appendChild(t)}document.addEventListener("DOMContentLoaded",()=>{ie(),setTimeout(()=>{R.init()},1e3)});typeof window<"u"&&(window.FABMenu=R);
