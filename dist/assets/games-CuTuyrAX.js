import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              *//* empty css                            *//* empty css                       */import{showToast as N}from"./utils-JAWsQOk8.js";import{s as D}from"./tts-BuOrQ7kI.js";import{A as p}from"./config-CfHoVMbv.js";import{L as G}from"./i18n-Dru8U3nj.js";import{C as R}from"./ui-enhancements-BcplSgJk.js";import{T as F}from"./toast-manager-B6dAfcdf.js";import"./pwa-Bxh5GLjF.js";function j(){console.log("[GamesUI] Initializing..."),y(),b(),w(),S(),U(),X(),requestAnimationFrame(()=>{K()}),window.dictionaryData?v():window.addEventListener("dictionaryLoaded",()=>v(),{once:!0}),window.filterGames=z,window.openDailyChallenge=W,window.updateGameScore=Z,window.updateGamesStats=H,window.trackGamePlayed=Q}function U(){const e=document.getElementById("mobileToggle");e&&e.addEventListener("click",()=>{var t;(t=window.MobileViewManager)==null||t.toggle()})}function X(){"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("../sw.js").then(e=>{console.log("SW registered: ",e),e.update()}).catch(e=>{console.error("SW registration failed: ",e)})})}function y(){const e=JSON.parse(localStorage.getItem("gamesStats")||'{"gamesPlayed": 0, "winStreak": 0, "totalScore": 0}'),t=document.getElementById("gamesPlayedStat"),a=document.getElementById("winStreakStat"),s=document.getElementById("totalScoreStat");t&&(t.textContent=e.gamesPlayed||0),a&&(a.textContent=e.winStreak||0),s&&(s.textContent=e.totalScore||0)}function H(e,t=0){const a=JSON.parse(localStorage.getItem("gamesStats")||'{"gamesPlayed": 0, "winStreak": 0, "totalScore": 0}');a.gamesPlayed++,a.totalScore+=t,e?a.winStreak++:a.winStreak=0,localStorage.setItem("gamesStats",JSON.stringify(a)),y(),V()}function b(){var s;const e=new Date().toISOString().split("T")[0];let t=JSON.parse(localStorage.getItem("dailyGameChallenge")||"{}");t.date!==e&&(t={date:e,gamesPlayed:0,completed:!1},localStorage.setItem("dailyGameChallenge",JSON.stringify(t)));const a=document.getElementById("dailyProgress");a&&(a.textContent=`${t.gamesPlayed}/3`),t.completed&&((s=document.getElementById("dailyChallengeBanner"))==null||s.classList.add("completed"))}function V(){const e=new Date().toISOString().split("T")[0];let t=JSON.parse(localStorage.getItem("dailyGameChallenge")||"{}");if(t.date!==e&&(t={date:e,gamesPlayed:0,completed:!1}),!t.completed){if(t.gamesPlayed++,t.gamesPlayed>=3){t.completed=!0;const a=JSON.parse(localStorage.getItem("gamesStats")||"{}");a.totalScore=(a.totalScore||0)+100,localStorage.setItem("gamesStats",JSON.stringify(a)),N('<span class="sv-text">🎉 Daglig utmaning klar! +100 poäng</span><span class="ar-text">🎉 تحدي اليوم مكتمل! +100 نقطة</span>')}localStorage.setItem("dailyGameChallenge",JSON.stringify(t))}b()}function W(){const e=document.querySelector(".game-cards-grid");e&&e.scrollIntoView({behavior:"smooth"})}const J={vocab:["Vokaler","Neon Search","Hangman","Memory","Minneskor","Bokstav Länk","Ord Hjulet","Svenska Wordle","Gissa Ordet"],grammar:["Grammatik","Bygg Meningen","Fyll i"],listening:["Lyssna","Uttalscoach"],puzzle:["Lås Upp","Neon Blocks","Ord-Regn"]};function z(e){var a;document.querySelectorAll(".category-chip").forEach(s=>s.classList.remove("active")),(a=document.querySelector(`[data-cat="${e}"]`))==null||a.classList.add("active"),document.querySelectorAll(".game-card-item").forEach(s=>{var n;const o=((n=s.querySelector("h3"))==null?void 0:n.textContent)||"";if(e==="all")s.style.display="";else{const r=(J[e]||[]).some(l=>o.includes(l));s.style.display=r?"":"none"}})}function w(){const e=JSON.parse(localStorage.getItem("gameScores")||"{}");document.querySelectorAll(".game-stars").forEach(t=>{const a=t.dataset.game;if(!a)return;const s=e[a]||0;let o=0;s>=100?o=3:s>=50?o=2:s>=10&&(o=1),o>0&&t.setAttribute("data-stars",o.toString())})}function Z(e,t){const a=JSON.parse(localStorage.getItem("gameScores")||"{}"),s=a[e]||0;t>s&&(a[e]=t,localStorage.setItem("gameScores",JSON.stringify(a))),w()}function S(){const e=JSON.parse(localStorage.getItem("gamesStats")||"{}"),t=new Date().toISOString().split("T")[0],a=Y(),s=e.bestStreak||e.winStreak||0,o=document.getElementById("bestStreak");o&&(o.textContent=s);const n=JSON.parse(localStorage.getItem("dailyGamesLog")||"{}"),i=n[t]||0,r=document.getElementById("todayGames");r&&(r.textContent=i);let l=0;Object.keys(n).forEach(d=>{d>=a&&(l+=n[d])});const c=document.getElementById("weeklyGames");c&&(c.textContent=l.toString())}function Y(){const e=new Date,t=e.getDay(),a=e.getDate()-t+(t===0?-6:1);return new Date(e.setDate(a)).toISOString().split("T")[0]}function Q(){const e=new Date().toISOString().split("T")[0],t=JSON.parse(localStorage.getItem("dailyGamesLog")||"{}");t[e]=(t[e]||0)+1,localStorage.setItem("dailyGamesLog",JSON.stringify(t));const a=JSON.parse(localStorage.getItem("gamesStats")||"{}");(!a.bestStreak||a.winStreak>a.bestStreak)&&(a.bestStreak=a.winStreak,localStorage.setItem("gamesStats",JSON.stringify(a))),S()}function v(){const e=window.dictionaryData;if(!e||!e.length)return;const t=new Date().toISOString().split("T")[0];let a=JSON.parse(localStorage.getItem("wotd_cache")||"{}");if(a.date!==t){const c=Math.floor(Math.random()*e.length);let d=e[c];for(let f=0;f<10&&!d[p.COLUMNS.EXAMPLE_SWE];f++)d=e[Math.floor(Math.random()*e.length)];a={date:t,word:d},localStorage.setItem("wotd_cache",JSON.stringify(a))}const s=a.word;if(!s)return;const o=document.getElementById("wordOfTheDay");o&&(o.style.display="block");const n=document.getElementById("wotd-swedish"),i=document.getElementById("wotd-arabic"),r=document.getElementById("wotd-example");n&&(n.textContent=s[p.COLUMNS.SWEDISH]),i&&(i.textContent=s[p.COLUMNS.ARABIC]),r&&(r.innerHTML=s[p.COLUMNS.EXAMPLE_SWE]||'<span class="sv-text">Ingen exempelmening</span><span class="ar-text">لا يوجد مثال</span>');const l=document.getElementById("wotd-speak-btn");l&&(l.onclick=c=>{c.stopPropagation(),D(s[p.COLUMNS.SWEDISH]);const d=l.querySelector("svg");d&&(d.style.fill="#fff"),setTimeout(()=>{d&&(d.style.fill="none")},1e3)})}function K(){const e=document.querySelectorAll(".game-card-item");e.length&&e.forEach(t=>{const a=t;a.addEventListener("mousemove",s=>{const o=a.getBoundingClientRect(),n=s.clientX-o.left,i=s.clientY-o.top,r=o.width/2,l=o.height/2,c=(i-l)/l*-8,d=(n-r)/r*8;a.style.transform=`perspective(1000px) rotateX(${c}deg) rotateY(${d}deg) scale(1.02)`}),a.addEventListener("mouseleave",()=>{a.style.transform="perspective(1000px) rotateX(0) rotateY(0) scale(1)"})})}typeof window<"u"&&document.addEventListener("DOMContentLoaded",()=>{G.init(),j()});const k={isActive:!1,init(){this.isActive=localStorage.getItem("focusMode")==="true",this.isActive&&document.body.classList.add("focus-mode")},createToggleButton(){if(document.querySelector(".focus-mode-toggle"))return;const t=document.createElement("button");t.className="focus-mode-toggle",t.setAttribute("aria-label","Toggle Focus Mode"),t.innerHTML=`
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" 
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
            </svg>
        `,t.addEventListener("click",()=>this.toggle()),document.body.appendChild(t)},toggle(){this.isActive=!this.isActive,document.body.classList.toggle("focus-mode",this.isActive),localStorage.setItem("focusMode",String(this.isActive)),"vibrate"in navigator&&navigator.vibrate(this.isActive?[20,50,20]:10),u(this.isActive?"Fokusläge aktiverat ✨":"Fokusläge avaktiverat",this.isActive?"success":"info")}},m={xpPerLevel:100,levelMultiplier:1.5,getProgress(){const e=localStorage.getItem("userProgress");return e?JSON.parse(e):{xp:0,level:1,streak:0,gamesPlayed:0,totalScore:0,wordsLearned:0,timeSpent:0,achievements:[],lastPlayDate:"",dailyGoalsCompleted:0}},saveProgress(e){localStorage.setItem("userProgress",JSON.stringify(e))},getXPForLevel(e){return Math.floor(this.xpPerLevel*Math.pow(this.levelMultiplier,e-1))},addXP(e){const t=this.getProgress();t.xp+=e;const a=this.getXPForLevel(t.level);let s=!1;for(;t.xp>=a;)t.xp-=a,t.level++,s=!0;return this.saveProgress(t),s&&this.showLevelUp(t.level),{newLevel:s,level:t.level,totalXP:t.xp}},showLevelUp(e){const t=document.createElement("div");t.className="level-up-overlay",t.innerHTML=`
        ...
        `,document.body.appendChild(t),g.play("achievement"),"vibrate"in navigator&&navigator.vibrate([30,50,30,50,30]),setTimeout(()=>{t.style.animation="fadeOut 0.5s ease forwards",setTimeout(()=>t.remove(),500)},3500)},showBadges(e){this.loadUnlocked();const t=document.createElement("div");t.className="achievements-grid",t.style.cssText="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; padding: 16px;",this.list.forEach(a=>{const s=document.createElement("div");s.className=`achievement-badge ${a.unlocked?"unlocked":"locked"}`,s.innerHTML=`
            ...
            `).join("")}
        `,e.appendChild(t)}},_={rewards:[{type:"xp",value:10,icon:"✨",name:"10 XP"},{type:"xp",value:25,icon:"⭐",name:"25 XP"},{type:"xp",value:50,icon:"💫",name:"50 XP"},{type:"xp",value:100,icon:"🌟",name:"100 XP"},{type:"streak-freeze",value:1,icon:"❄️",name:"Streak Freeze"},{type:"double-xp",value:1,icon:"🔥",name:"Dubbel XP (1 spel)"}],canOpen(){const e=m.getProgress();if(!e.mysteryBoxLastOpened)return!0;const t=new Date(e.mysteryBoxLastOpened);return(new Date().getTime()-t.getTime())/(1e3*60*60)>=24},open(){if(!this.canOpen())return u("Vänta till imorgon för nästa låda! 📦","info"),null;const e=this.rewards[Math.floor(Math.random()*this.rewards.length)],t=m.getProgress();return t.mysteryBoxLastOpened=new Date().toISOString(),m.saveProgress(t),e.type==="xp"&&m.addXP(e.value),this.showReward(e),e},showReward(e){const t=document.createElement("div");t.className="level-up-overlay",t.innerHTML=`
            <div class="level-up-content">
    ...
    `,e.className="progress-ring-container"}document.addEventListener("DOMContentLoaded",()=>{setTimeout(()=>{k.init(),g.init(),A.init(),x.loadUnlocked(),h.load(),h.updateProgress("streak",1)},500)});typeof window<"u"&&(window.FocusMode=k,window.XPSystem=m,window.Achievements=x,window.DailyGoals=h,window.MysteryBox=_,window.PomodoroTimer=A,window.SoundEffects=g,window.Celebrations=R,window.createProgressRing=ee,window.showToast=u);const E={init(){document.querySelectorAll(".game-card-item").forEach(e=>{this.addTiltEffect(e)})},addTiltEffect(e){e.classList.add("tilt-card");const t=document.createElement("div");t.className="tilt-shine",e.appendChild(t),e.addEventListener("mousemove",a=>{const s=e.getBoundingClientRect(),o=a.clientX-s.left,n=a.clientY-s.top,i=s.width/2,r=s.height/2,l=(n-r)/10,c=(i-o)/10;e.style.setProperty("--tilt-x",`${l}deg`),e.style.setProperty("--tilt-y",`${c}deg`),t.style.background=`radial-gradient(circle at ${o}px ${n}px, rgba(255,255,255,0.2) 0%, transparent 50%)`}),e.addEventListener("mouseleave",()=>{e.style.setProperty("--tilt-x","0deg"),e.style.setProperty("--tilt-y","0deg")})}},M={difficulties:{flashcards:"easy",vokaler:"medium","unblock-me":"hard","block-puzzle":"medium","word-search":"easy",hangman:"medium",memory:"easy","word-wheel":"medium","word-connect":"hard","fill-blank":"medium",listening:"medium",grammar:"hard","missing-word":"medium",spelling:"hard","sentence-builder":"hard","word-rain":"medium",wordle:"hard",pronunciation:"hard"},labels:{easy:{sv:"Lätt",ar:"سهل"},medium:{sv:"Medel",ar:"متوسط"},hard:{sv:"Svårt",ar:"صعب"}},init(){document.querySelectorAll(".game-card-item").forEach(e=>{const t=e.getAttribute("data-game-id");t&&this.difficulties[t]&&this.addBadge(e,this.difficulties[t])})},addBadge(e,t){var o;if(e.querySelector(".difficulty-badge"))return;const s=document.createElement("span");s.className=`difficulty-badge difficulty-${t}`,s.textContent=((o=this.labels[t])==null?void 0:o.sv)||t,e.appendChild(s)}},L={init(){const e=localStorage.getItem("lastPlayedGame");if(!e)return;const t=JSON.parse(e),a=document.querySelector(`[data-game-id="${t.gameId}"]`);a&&this.addBadge(a)},addBadge(e){if(e.querySelector(".last-played-badge"))return;const a=document.createElement("div");a.className="last-played-badge",a.innerHTML=`
            <svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z"/>
            </svg>
            Senast
        `,e.appendChild(a)},recordPlay(e){localStorage.setItem("lastPlayedGame",JSON.stringify({gameId:e,timestamp:Date.now()}))}},T={recommendations:{memory:5,flashcards:5,grammar:4,vokaler:5,"word-connect":4,hangman:4,"fill-blank":3,listening:4,"word-wheel":3,wordle:3,pronunciation:4,spelling:3,"sentence-builder":3,"word-rain":4,"missing-word":3,"unblock-me":2,"block-puzzle":2,"word-search":3},init(){document.querySelectorAll(".game-card-item").forEach(e=>{const t=e.getAttribute("data-game-id");t&&this.recommendations[t]&&this.addStars(e,this.recommendations[t])})},addStars(e,t){var n;if(e.querySelector(".recommendation-stars"))return;const s=document.createElement("div");s.className="recommendation-stars";for(let i=1;i<=5;i++){const r=document.createElement("svg");r.className=`recommendation-star ${i>t?"empty":""}`,r.setAttribute("viewBox","0 0 24 24"),r.innerHTML='<path fill="currentColor" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>',s.appendChild(r)}const o=e.querySelector(".high-score, .game-stars");o?(n=o.parentNode)==null||n.insertBefore(s,o.nextSibling):e.appendChild(s)}},te={baseCount:12,init(){const e=document.querySelector(".games-container");if(!e||document.querySelector(".live-players-widget"))return;const a=this.createWidget(),s=document.getElementById("xpWidget");if(s&&s.nextSibling)e.insertBefore(a,s.nextSibling);else{const o=document.querySelector(".games-header");o&&o.nextSibling&&e.insertBefore(a,o.nextSibling)}this.startUpdating()},createWidget(){const e=this.getRandomCount(),t=document.createElement("div");return t.className="live-players-widget",t.innerHTML=`
        ...
        `}).join("")}},I={intervalMinutes:30,timer:null,startTime:0,init(){this.startTime=Date.now(),this.scheduleReminder()},scheduleReminder(){this.timer&&clearTimeout(this.timer),this.timer=setTimeout(()=>{this.showReminder()},this.intervalMinutes*60*1e3)},showReminder(){var t,a;const e=document.createElement("div");e.className="break-reminder-overlay",e.id="breakReminder",e.innerHTML=`
        ...
        `,t.addEventListener("click",()=>{const a=document.querySelector(`[data-game-id="${e.game}"]`);a&&(a.scrollIntoView({behavior:"smooth",block:"center"}),a.style.animation="pulse 0.5s ease")}),t}},se={init(){const e=new IntersectionObserver(t=>{t.forEach(a=>{a.isIntersecting&&(a.target.classList.add("bounce-scroll"),e.unobserve(a.target))})},{threshold:.1});document.querySelectorAll(".game-card-item").forEach(t=>{e.observe(t)})}};document.addEventListener("DOMContentLoaded",()=>{setTimeout(()=>{E.init(),M.init(),L.init(),T.init(),P.init(),q.init(),$.init(),I.init(),C.init(),B.init(),se.init()},800)});typeof window<"u"&&(window.TiltEffect=E,window.DifficultyIndicator=M,window.LastPlayedBadge=L,window.RecommendationStars=T,window.LivePlayersCounter=te,window.MotivationalQuotes=ae,window.ProgressDashboard=B,window.BreakReminder=I,window.EyeCareMode=C,window.GameMascot=P,window.WeeklyLeaderboard=q,window.AIRecommendations=$);const O={isOpen:!1,menuElement:null,menuItems:[{id:"focus-mode",icon:`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
...
`;function ne(){const e="fab-menu-styles";if(document.getElementById(e))return;const t=document.createElement("style");t.id=e,t.textContent=oe,document.head.appendChild(t)}document.addEventListener("DOMContentLoaded",()=>{ne(),setTimeout(()=>{O.init()},1e3)});typeof window<"u"&&(window.FABMenu=O);
